  ...
  const notes = [
    {
      ...
      date: '2025-11-01',
      content: 'finally ditched Windows for Linux Mint and its wayyy smoother than I expected. No random updates, no unnecessary widgets popping on my lockscreen, no bloat. Spent the day customizing the look and i absolutely love it. Its fast, stable, and crazy customizable. You can make it look cute, edgy, or sleek. Thats what I love and hate about Linux — youre in control of everything, for better or worse. But honestly, that freedom hits different.',
    },
    {
      id: 2,
      title: 'Automating with n8n',
      date: '2025-10-07',
      content: 'Stumbled across an n8n youtube tutorial and life doesnt feel the same after that lol. Its wild how much you can automate with it. I  Set up a workflow that grabs tech news and drops it straight into my Discord server (not a big deal but i feel like GOD after doing this, let me have my moment). I also have a workflow for adding new notes to this page. Thinking about how i can exploit n8n next.Once you start automating (exploiting n8n), doing things manually just feels dumb (you get lazier).',
    },
    {
      id: 3,
